/// A Flutter library for drawing and viewing robot paths on field images.
/// See [BotPathDrawer] (for recording) and [BotPathViewer] (for playback).
/// Both configured via [BotPathConfig].
library;

export 'src/models/bot_path_config.dart';
