...
<Head>
    <title>Simulation System Design - FEDS201</title>
    <meta property="og:title" content="Simulation System Design - FEDS201" key="title" />
...
#### Running the REBUILT Simulation

**From VS Code (Recommended):**

1. Open the `robot/2026-rebuilt/` project in VS Code
...
3. You will see the 3D field with the robot and all fuel balls
4. Use the Driver Station sim GUI to enable the robot and drive it around

**What to Expect:**

- The robot appears on the REBUILT field with hundreds of fuel balls
- You can drive using a connected gamepad or the on-screen driver station
- Fuel balls react to the robot: intake picks them up, shooter launches them
- Scoring happens automatically when balls enter the hub zones
- All telemetry is live: pose, scores, held ball count, component positions
