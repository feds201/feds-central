...
public @interface RobotAction {
    /** The type of action test being performed. */
    enum ActionType {
        DIAGNOSTIC, TUNING
    }
    ...
    /** Specifies what kind of test this is (e.g. standard diagnostic or PID/feedforward tuning). */
    ActionType type() default ActionType.DIAGNOSTIC;
