...
public class PathfindToPose extends Command {
  ...
  public PathfindToPose(CommandSwerveDrivetrain dt, Pose2d targetPose) {
    ...
    driveRequest =
        new SwerveRequest.FieldCentric().withDeadband(MAX_SPEED * .07)
  ...
  public void execute() {
    ...
    double rotationOutput =
        rotPID.calculate(currentPose.getRotation().getDegrees(), // current rotation
    ...
    double maxAngularRateDegreesPerSecond =
        RotationsPerSecond.of(2).in(DegreesPerSecond);
    rotationOutput = MathUtil.clamp(rotationOutput,
        -maxAngularRateDegreesPerSecond, maxAngularRateDegreesPerSecond);
