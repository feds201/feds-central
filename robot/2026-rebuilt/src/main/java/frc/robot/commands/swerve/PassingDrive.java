...
public class PassingDrive extends Command {
  ...
  private static final PIDController passRotPID = new PIDController(25, 0, 0);
 private SwerveRequest.FieldCentric driveNormal;
  ...
  public void execute() {
    ...
    dt.setControl(driveNormal
              ...
              .withRotationalRate(passRotPID.calculate(robotHeading, angleToTarget)));
  }
