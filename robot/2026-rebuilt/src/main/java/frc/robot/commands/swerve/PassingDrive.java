...
public class PassingDrive extends Command {
  ...
  private static Translation2d aimRight =
      RobotMap.ShooterConstants.passingRight;
  ...
  public PassingDrive(CommandSwerveDrivetrain dt,
  ...
  public void execute() {
    ...
    double angleToTarget =
        Math.toDegrees(Math.atan2(aimLoc.getY() - robotPose.getY(),
            aimLoc.getX() - robotPose.getX()));
