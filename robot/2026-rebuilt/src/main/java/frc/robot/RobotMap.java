 ...
 * This provides flexibility changing wiring.
 */
public final class RobotMap {
  ...
  public static class VisionConstants {
    ...
    public static final Matrix<N3, N1> MT1_STDDEV =
        VecBuilder.fill(1e16, 1e16, Math.PI / 60);
    ...
    public static final Matrix<N3, N1> MT2_STDDEV =
        VecBuilder.fill(0.5, 0.5, 1e16);
  }
  ...
  public static class DrivetrainConstants {
    ...
    public static CommandSwerveDrivetrain createDrivetrain() {
      SwerveModuleStatusUtil.addSwerveModule(
          SwerveModuleStatusUtil.ModuleLocation.FL, kFrontLeftDriveMotorId,
          kFrontLeftSteerMotorId, kFrontLeftEncoderId);
      SwerveModuleStatusUtil.addSwerveModule(
          SwerveModuleStatusUtil.ModuleLocation.FR, kFrontRightDriveMotorId,
          kFrontRightSteerMotorId, kFrontRightEncoderId);
      SwerveModuleStatusUtil.addSwerveModule(
          SwerveModuleStatusUtil.ModuleLocation.BL, kBackLeftDriveMotorId,
          kBackLeftSteerMotorId, kBackLeftEncoderId);
      SwerveModuleStatusUtil.addSwerveModule(
          SwerveModuleStatusUtil.ModuleLocation.BR, kBackRightDriveMotorId,
  ...
  public static class ShooterConstants {
    ...
    public static final AngularVelocity velocityTolerance =
    ...
    public static final Translation2d robotShooterOffset =
        new Translation2d(.25, 0); // TODO: tune
    // rotation of the shooter relative to robot forward
    public static final Rotation2d robotToShooterRotation =
        Rotation2d.fromDegrees(0.0);
    public static final Translation2d hubCenter =
        FieldConstants.Hub.innerCenterPoint.toTranslation2d();
    public static final Rectangle2d trench =
        new Rectangle2d(robotShooterOffset, hubCenter);
    public static final Translation2d passingRight =
        FieldConstants.Outpost.centerPoint.plus(new Translation2d(0, 2));
    public static final Translation2d passingLeft =
        new Translation2d(0, 7.44).minus(new Translation2d(0, 2));
    public static final Translation2d BlueLeftTopLeft =
        new Translation2d(4.0, 11.208);
    public static final Translation2d BlueLeftBottomRight =
        new Translation2d(5.17, 6.75);
    public static final Rectangle2d BlueLeftTrench =
        new Rectangle2d(BlueLeftTopLeft, BlueLeftBottomRight);

    public static final Translation2d RedLeftTopLeft =
        new Translation2d(11.375, 1.221);
    public static final Translation2d RedLeftBottomRight =
        new Translation2d(12.6, -3);
    public static final Rectangle2d RedLeftTrench =
        new Rectangle2d(RedLeftTopLeft, RedLeftBottomRight);

    public static final Translation2d BlueRightTopLeft =
        new Translation2d(5.2, -3);
    public static final Translation2d BlueRightBottomRight =
        new Translation2d(4, 1.26);
    public static final Rectangle2d BlueRightTrench =
        new Rectangle2d(BlueRightTopLeft, BlueRightBottomRight);

    public static final Translation2d RedRightTopRight =
        new Translation2d(12.56, 6.88);
    public static final Translation2d RedRightBottomRight =
        new Translation2d(11.181, 11);
    public static final Rectangle2d RedRightTrench =
        new Rectangle2d(RedRightTopRight, RedRightBottomRight);

    public static final Rectangle2d neutralZone = new Rectangle2d(
        new Translation2d(5.618, 8.0), new Translation2d(10.922, 0.0));

    public static final Rectangle2d redAlliance = new Rectangle2d(
        new Translation2d(11.777, 8.0), new Translation2d(16.5, 0.0));
    public static final Rectangle2d blueAlliance = new Rectangle2d(
        new Translation2d(0.0, 0.0), new Translation2d(4.830, 8.0));

    // This map is used to determine the velocity of the shooter based on the distance to the target.
    // The key is the distance to the target in meters, and the value is the velocity of the shooter in
    // rotations per second.`
    public static final InterpolatingDoubleTreeMap kShootingVelocityMap =
        InterpolatingDoubleTreeMap.ofEntries(Map.entry(1.44, 28.0), // done
    ...
    public static final InterpolatingDoubleTreeMap kShootingPositionMap =
        InterpolatingDoubleTreeMap.ofEntries(Map.entry(1.44, 0.0), // done
            ...
            Map.entry(4.75, 14.5), Map.entry(5.0, 15.5), // done
    ...
    public static final InterpolatingDoubleTreeMap kPassingVelocityMap =
        InterpolatingDoubleTreeMap.ofEntries(Map.entry(5.07, 26.0),
            Map.entry(6.5, 30.0), Map.entry(8.53, 35.0), Map.entry(11.12, 44.0),
            Map.entry(12.0, 80.0), Map.entry(14.0, 90.0)

        );


    public static final InterpolatingDoubleTreeMap kPassingPositionMap =
        InterpolatingDoubleTreeMap.ofEntries(Map.entry(5.07, 29.0),
            Map.entry(6.5, 29.0), Map.entry(8.53, 29.0), Map.entry(11.12, 29.0),
            Map.entry(12.0, 30.0), Map.entry(14.0, 30.0));
