...
public final class RobotMap {
  ...
  public static class DrivetrainConstants {
    ...
    public static CommandSwerveDrivetrain createDrivetrain() {
      SwerveModuleStatusUtil.addSwerveModule(SwerveModuleStatusUtil.ModuleLocation.FL,
          kFrontLeftDriveMotorId, kFrontLeftSteerMotorId, kFrontLeftEncoderId);
      SwerveModuleStatusUtil.addSwerveModule(SwerveModuleStatusUtil.ModuleLocation.FR,
          kFrontRightDriveMotorId, kFrontRightSteerMotorId, kFrontRightEncoderId);
      SwerveModuleStatusUtil.addSwerveModule(SwerveModuleStatusUtil.ModuleLocation.BL,
          kBackLeftDriveMotorId, kBackLeftSteerMotorId, kBackLeftEncoderId);
      SwerveModuleStatusUtil.addSwerveModule(SwerveModuleStatusUtil.ModuleLocation.BR,
          kBackRightDriveMotorId, kBackRightSteerMotorId, kBackRightEncoderId);
  ...
  public static class PitConstants {
    ...
    final static long STORAGE_PER_MATCH_BYTES = 100_000_000L; // confirmed we use ~100MB/match for
                                                              // logs!
  ...
  public static class ShooterConstants {
    ...
    /**
     * Physical hood angle in degrees when the motor is at HOOD_FORWARD_SOFT_LIMIT_ROT (fully
     * extended).
     */
    ...
    public static final Rectangle2d neutralZone =
        new Rectangle2d(new Translation2d(5.618, 8.0), new Translation2d(10.922, 0.0));

    public static final Rectangle2d redAlliance =
        new Rectangle2d(new Translation2d(11.777, 8.0), new Translation2d(16.5, 0.0));
    public static final Rectangle2d blueAlliance =
        new Rectangle2d(new Translation2d(0.0, 0.0), new Translation2d(4.830, 8.0));

    // This map is used to determine the velocity of the shooter based on the distance to the
    // target.
    // The key is the distance to the target in meters, and the value is the velocity of the shooter
    // in
    ...
    public static final InterpolatingDoubleTreeMap kShootingVelocityMap =
        InterpolatingDoubleTreeMap.ofEntries(Map.entry(1.44, 28.0), // done
            ...
            Map.entry(100.0, 45.5)// far off top limit to prevent unwanted scaling past this
                                  // distance
        );
    ...
    public static final InterpolatingDoubleTreeMap kShootingPositionMap =
        InterpolatingDoubleTreeMap.ofEntries(Map.entry(1.44, 0.0), // done
            ...
            Map.entry(100.0, 29.5) // far off top limit to prevent unwanted scaling past this
                                   // distance
        );

    public static final InterpolatingDoubleTreeMap kPassingVelocityMap = InterpolatingDoubleTreeMap
        .ofEntries(Map.entry(5.07, 26.0), Map.entry(6.5, 30.0), Map.entry(8.53, 35.0),
            Map.entry(11.12, 44.0), Map.entry(12.0, 80.0), Map.entry(14.0, 90.0)

        );


    public static final InterpolatingDoubleTreeMap kPassingPositionMap = InterpolatingDoubleTreeMap
        .ofEntries(Map.entry(5.07, 29.0), Map.entry(6.5, 29.0), Map.entry(8.53, 29.0),
            Map.entry(11.12, 29.0), Map.entry(12.0, 30.0), Map.entry(14.0, 30.0));
