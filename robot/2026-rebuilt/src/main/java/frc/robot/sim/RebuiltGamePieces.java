...
public class RebuiltGamePieces {
  ...
  public static final GamePieceConfig FUEL =
      new GamePieceConfig.Builder().withName("Fuel")
          .withShape(GamePieceConfig.Shape.SPHERE).withRadius(0.075) // 75mm radius = 150mm diameter (~6 inches)
          .withMass(0.2) // ~0.2 kg
