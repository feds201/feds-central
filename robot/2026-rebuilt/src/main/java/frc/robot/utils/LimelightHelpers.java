...
public class LimelightHelpers {
  ...
  public static class RawDetection {
    ...
    public RawDetection(int classId, double txnc, double tync, double ta,
        ...
        double corner2_X, double corner2_Y, double corner3_X,
        double corner3_Y) {
  ...
  private static PoseEstimate getBotPoseEstimate(String limelightName,
      String entryName, boolean isMegaTag2) {
    ...
    if (poseArray.length != expectedTotalVals) {
      ...
      for (int i = 0; i < tagCount; i++) {
        ...
        rawFiducials[i] = new RawFiducial(id, txnc, tync, ta, distToCamera,
            distToRobot, ambiguity);
      }
    }

    return new PoseEstimate(pose, adjustedTimestamp, latency, tagCount, tagSpan,
        tagDist, tagArea, rawFiducials, isMegaTag2);
  }
  ...
  public static RawFiducial[] getRawFiducials(String limelightName) {
    var entry = LimelightHelpers.getLimelightNTTableEntry(limelightName,
        "rawfiducials");
  ...
  public static RawDetection[] getRawDetections(String limelightName) {
    ...
    for (int i = 0; i < numDetections; i++) {
      ...
      rawDetections[i] =
          new RawDetection(classId, txnc, tync, ta, corner0_X, corner0_Y,
  ...
  /**
   * Gets the raw target contours from NetworkTables. Returns ungrouped contours in normalized screen
   * space (-1 to 1).
   *
   * @param limelightName Name/identifier of the Limelight
  ...
  public static RawTarget[] getRawTargets(String limelightName) {
    var entry =
        LimelightHelpers.getLimelightNTTableEntry(limelightName, "rawtargets");
  ...
  /**
   * Prints detailed information about a PoseEstimate to standard output. Includes timestamp, latency,
   * tag count, tag span, average tag distance, average tag area, and detailed information about each
   * detected fiducial.
   *
  ...
  public static void printPoseEstimate(PoseEstimate pose) {
    ...
    for (int i = 0; i < pose.rawFiducials.length; i++) {
      ...
      System.out.printf("  Distance to Robot: %.2f meters%n",
  ...
  public static Boolean validPoseEstimate(PoseEstimate pose) {
    return pose != null && pose.rawFiducials != null
  ...
  public static String[] getLimelightNTStringArray(String tableName,
      String entryName) {
    return getLimelightNTTableEntry(tableName, entryName)
  ...
  /**
   * Gets the MegaTag1 Pose2d and timestamp for use with WPILib pose estimator (addVisionMeasurement)
   ...
   * in the WPILib Blue alliance coordinate system. Make sure you are calling setRobotOrientation()
   * before calling this method.
   *
   * @param limelightName
   * @return
   */
  public static PoseEstimate getBotPoseEstimate_wpiBlue_MegaTag2(
  ...
  /**
   * Gets the Pose2d and timestamp for use with WPILib pose estimator (addVisionMeasurement) when you
   * are on the RED alliance
   *
   * @param limelightName
   * @return
   */
   ...
   */
  public static void setKeystone(String limelightName, double horizontal,
      double vertical) {
   ...
   */
  public static void setFiducial3DOffset(String limelightName, double offsetX,
  ...
  public static void SetRobotOrientation(String limelightName, double yaw,
      double yawRate, double pitch, double pitchRate, double roll,
      double rollRate) {
    SetRobotOrientation_INTERNAL(limelightName, yaw, yawRate, pitch, pitchRate,
        roll, rollRate, true);
  }

  public static void SetRobotOrientation_NoFlush(String limelightName,
      double yaw, double yawRate, double pitch, double pitchRate, double roll,
      double rollRate) {
    SetRobotOrientation_INTERNAL(limelightName, yaw, yawRate, pitch, pitchRate,
        roll, rollRate, false);
  }
   ...
   */
  public static void SetFiducialIDFiltersOverride(String limelightName,
      int[] validIDs) {
   ...
   * at the cost of potentially reduced detection range.
   *
   * @param limelightName Name/identifier of the Limelight
   * @param downscale Downscale factor. Valid values: 1.0 (no downscale), 1.5, 2.0, 3.0, 4.0. Set to 0
   *        for pipeline control.
   */
  public static void SetFiducialDownscalingOverride(String limelightName,
      float downscale) {
    int d = 0; // pipeline
    if (downscale == 1.0) {
      d = 1;
  ...
  public static void setCameraPose_RobotSpace(String limelightName,
      double forward, double side, double up, double roll, double pitch,
      double yaw) {
    double[] entries = new double[6];
    entries[0] = forward;
    entries[1] = side;
  ...
  /**
   * Triggers a snapshot capture via NetworkTables by incrementing the snapshot counter. Rate-limited
   * to once per 10 frames on the Limelight.
   *
   * @param limelightName Name of the Limelight camera
   */
   ...
   */
  public static void triggerRewindCapture(String limelightName,
   ...
   *
   * For usbIndex 0: ports 5800-5809 forward to 172.29.0.1 For usbIndex 1: ports 5810-5819 forward to
   * 172.29.1.1 etc.
   *
