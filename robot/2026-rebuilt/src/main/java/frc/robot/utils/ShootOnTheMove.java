...
public class ShootOnTheMove {
   ...
   */
  public static Rotation2d calculateRobotHeading(Pose2d robotPose, ChassisSpeeds chassisSpeeds) {
    // Get shooter field position
    Translation2d shooterFieldPosition = getShooterFieldPosition(robotPose);
    ...
    Rotation2d shooterFieldAngle = new Rotation2d(shooterToGoal.getX(), shooterToGoal.getY());
   ...
   */
  private static Translation2d getShooterFieldVelocity(Pose2d robotPose, ChassisSpeeds speeds) {
    ...
    Translation2d rotationalVelocity =
        getRotationalVelocityContribution(robotPose.getRotation(), speeds.omegaRadiansPerSecond);
   ...
   */
  private static Translation2d getRotationalVelocityContribution(Rotation2d robotHeading,
      double omega) {
