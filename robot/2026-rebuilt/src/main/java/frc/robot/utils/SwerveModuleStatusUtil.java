...
/**
 * Utility class to integrate status and temperature reporting into swerve modules.
 */
public class SwerveModuleStatusUtil {
   ...
   */
  public synchronized static void addSwerveModule(ModuleLocation loc,
      int driveMotorID, int steerMotorID, int encoderID) {
    ...
    SubsystemStatusManager.addSubsystem("SwerveModule-" + loc.name(),
        driveMotor, steerMotor, encoder);
