...
public final class TestResult {
  ...
  public TestResult(String subsystemName, String actionName, String description, Status status,
      Throwable error, double durationMs, List<Alert> alerts,
    ...
    this.dataProfiles = dataProfiles != null ? deepCopyProfiles(dataProfiles) : Map.of();
  }

  /** Backwards-compatible constructor (no alerts / profiles). */
  public TestResult(String subsystemName, String actionName, String description, Status status,
      Throwable error, double durationMs) {
  ...
  private static Map<String, List<DataSample>> deepCopyProfiles(Map<String, List<DataSample>> src) {
